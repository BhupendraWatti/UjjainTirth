      ...
      {showText && (
        <Animated.View
          style={[
            ...
            { opacity: textOpacity, transform: [{ scale }] },
          ]}
        >
          <Text style={styles.title}>Coming Soon</Text>
          <Text style={styles.subtitle}>Something exciting is coming ✨</Text>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#f04343", // ✅ match your app
    justifyContent: "center",
    alignItems: "center",
  },

  animation: {
    width: "90%", // ✅ slight overflow for cinematic feel
    height: 330,
    position: "relative",
    top: -100,
  },
  ...
  textContainer: {
    position: "absolute",
    top: "57%", // ✅ slightly below center (feels natural)
    alignItems: "center",
  },
